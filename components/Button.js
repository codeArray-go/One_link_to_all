const Button = ({ text, click }) => {
    return (
        <div onClick={click} className="NunitoEB flex gap-2 items-center justify-around px-3 py-2 cursor-pointer bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-500 text-slate-800">
            {(text === "LogIn") ? (
